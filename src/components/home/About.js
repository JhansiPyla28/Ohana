        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              Ohana Homestay is the right choice for guests who are looking for a peaceful and memorable stay on the foothills of the Himalayas. This sprawling establishment has been tastefully constructed, decorated & maintained and gives the look of an old British bungalow. With modern amenities in the lap of nature, Ohana Homestay is the perfect getaway in the beautiful valley of Dehradun.
              </p>
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-6"  style={{ textAlign: "justify" }}>
              ...
              <p className="mb-4" >
                Enjoy a private holiday in a cosy home surrounded by the calling mountains. Perched in a valley bestowed by nature, this quaint homestay will win you over its warm homely vibe.
              </p>
              <p className="mb-4">
